...
<section class="lg:pb-24">
  <div class="max-w-screen-md px-4 mx-auto">
      <p class="mb-8 font-light text-center text-gray-500 lg:mb-16 dark:text-gray-400 sm:text-xl">Tell us whether you need SecureRAG Gateway, AI Search Growth, CareerLift Agent, or a custom multi-model workflow.</p>
      <form name="contact" action="https://formsubmit.co/daxixi.jimmy@gmail.com" method="POST" class="space-y-8">
          <div class="my-4">
